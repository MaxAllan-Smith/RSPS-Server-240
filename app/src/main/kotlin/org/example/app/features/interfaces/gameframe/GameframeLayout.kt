...
/**
 * Revision-240 resizable gameframe interface and component IDs.
 *
 * Centralized here so every handler that mounts or targets a gameframe
 * component references the same constants instead of re-declaring magic
