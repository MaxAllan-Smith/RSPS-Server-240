...
internal object WorldBootstrapper {
    ...
    private const val ROOT_WORLD: Int =
        0

    private const val FIXED_TOP_LEVEL_INTERFACE: Int =
        548

    private const val RESIZABLE_TOP_LEVEL_INTERFACE: Int =
        161

    /**
     * Current OSRS audio-option varps.
     */
    private const val JINGLE_VOLUME_VARP: Int =
        167

    private const val MUSIC_VOLUME_VARP: Int =
        168

    private const val SOUND_EFFECT_VOLUME_VARP: Int =
        169

    private const val AREA_SOUND_VOLUME_VARP: Int =
        872
     ...
     */
    private const val MASTER_VOLUME_VARP: Int =
        3796

    private const val FULL_MUSIC_VOLUME: Int =
        255

    private const val FULL_EFFECT_VOLUME: Int =
        127
}